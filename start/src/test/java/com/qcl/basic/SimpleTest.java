...
public class SimpleTest {
    ...
    // JWT Token配置 - 使用正确的token格式
    private static final String JWT_TOKEN = "eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJ0ZXN0XzUiLCJjcmVhdGVkIjoxNzY2NjQ4MTM1NDEwLCJleHAiOjE3NjY2NTE3MzV9.PR3KKVdFHNgpeJ-LtL2EwUJuFHGWFNOnX5Hc4GJdPGk";
    ...
    private HttpEntity<?> createAuthHttpEntity() {
        ...
        headers.set(AUTHORIZATION_HEADER, BEARER_PREFIX + JWT_TOKEN);
