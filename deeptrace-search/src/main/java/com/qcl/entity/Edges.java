...
public class Edges implements Serializable {
    ...
    @Field(name = "dst_nodeid")
    @JsonProperty("dst_nodeid")
    ...
    @Field(name = "src_nodeid")
    @JsonProperty("src_nodeid")
    ...
    public static class Metric implements Serializable {
        ...
        @Field(name = "end_times", type = FieldType.Date)
        ...
        @Field(name = "start_times", type = FieldType.Date)
